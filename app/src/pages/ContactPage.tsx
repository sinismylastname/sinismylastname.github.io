  ...
  return (
    <div className="page-content contact-page">
      ...
      <GlassSurface as="section" variant="panel" className="contact-layout" aria-label="Contact details and message form">
        <div className="contact-copy"><h2>Make something interesting.</h2><p>I’m always happy to talk about robotics, hardware, web development, games, or the strange little ideas that sit between them.</p><p className="form-note">This static form keeps native validation. Message delivery can be connected to a provider later without changing the visual experience.</p><a className="quiet-link" href="mailto:andy@example.com">andy@example.com ↗</a></div>
