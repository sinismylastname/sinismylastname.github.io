...
export function PortfolioPage() {
  ...
  return (
    <div className="page-content portfolio-page">
      <SectionHeading eyebrow="Selected work" title="Portfolio" text="I like building at the intersection of code, hardware, and the people who use it. Peek inside a few projects below." />
